...
<body id="page-top">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <h1 class="text-center text-primary">Selamat Datang di Dashboard Admin</h1>
                                    <p class="text-center mt-3">
                                        Halaman ini dirancang untuk mempermudah Anda dalam mengelola sistem. Silakan gunakan menu di sisi kiri untuk navigasi.
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Page level plugins -->
    <script src="../../Assets/styles/sb/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../../Assets/styles/sb/js/demo/chart-area-demo.js"></script>
    <script src="../../Assets/styles/sb/js/demo/chart-pie-demo.js"></script>

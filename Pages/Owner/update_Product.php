<?php
    ...
    //query data product berdasarkan idProduct
    $product = query("SELECT * FROM product WHERE idProduct = $id" ) [0];
...
<head>
    ...
    <title>Alope Store Update-Product</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-grey-800" style="text-align:center;">Edit Barang</h1>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="gambarLama" value = " <?= $product["img"] ; ?> " >

                                        <div class="form-group">
                                            <label for="file">Upload Gambar</label>
                                            <img src="../../Assets/images/<?= $product["img"] ; ?>" width="70px" alt="" > <br>
                                            <input type="file" name="img" id="file" class="form-control" value="<?= $product["img"] ; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama">Nama Product</label>
                                            <input type="text" name="nameProduct" id="nama" class="form-control" value="<?= $product["nameProduct"] ; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" inputmode="numeric" name="price" id="price" class="form-control" value="<?= $product["price"] ; ?>">
                                        </div>

...
<head>
    ...
    <title>Alope Store List Product</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between ">
                            <h6 class="m-0 font-weight-bold text-primary mb-0 text-gray-800">Item Data Tables</h6>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../../Assets/images/<?php echo $row["img"] ?>" width="45"></td>
                                            <td> <?= $row["category"] ?> </td>
                                            <!-- <td> <?= $row["tanggal_masuk"] ?> </td> -->
                                            <td> <?= "Rp ". number_format($row["price"], 0, ',', '.') ; ?> </td>
                                            <td><a href="update_Product.php?idProduct=<?php echo $row["idProduct"] ?>" class="btn btn-warning">
                                                <i class="far fa-edit"></i></a> |
                                                <a href="delete_Product.php?idProduct=<?php echo $row["idProduct"] ?>" class="btn btn-danger"
                                                    onclick=" return confirm('yakin?') ; " ><i class="far fa-trash-alt"></i></a> 
                                            </td>

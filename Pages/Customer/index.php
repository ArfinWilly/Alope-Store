...
<nav class="navbar">
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h1 class="title">Selamat Datang di E-Commerce Kami</h1>
                <p class="description">
                    Terima Kasih telah mengunjungi platform kami. Temukan berbagai produk
                    berkualitas dan penawaran terbaik yang dirancang khusus untuk Anda.
                    Selamat Berbelanja.
                </p>
            </div>
        </div>

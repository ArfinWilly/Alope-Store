...
<body>
    ...
    <div class="order-status">
        <a data-aos="fade-right" data-aos-delay="750" href="transactions.php" class="a transactions">Proses</a>
        <a data-aos="fade-left" data-aos-delay="750" href="order_history.php" class="a history">Riwayat</a>
    </div>
    ...
    <?php
        ...
        foreach ($pesananList as $pesanan) {
            ...
            echo "<p><strong>Total Harga: Rp</strong> " . number_format($pesanan['totalPrice'], 0 , ',', '.') ;
            echo "</p>" ;
            echo "<p><strong>Uang Bayar: Rp</strong> " . number_format($pesanan['pay'], 0 , ',', '.') ; 
            echo "</p>" ;
            echo "<p><strong>Kembalian: Rp</strong> " . number_format($pesanan['returnPay'], 0 , ',', '.') ;  
            echo "</p>" ;
            echo '<a href="Cetak_struk.php?idPayment=' . $pesanan['idPayment'] . '" 
            target="_blank" class="btn struk">Cetak PDF</a>';

...
<nav class="navbar">
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h1 class="title">Selamat Datang di Dashboard Kurir</h1>
                <p class="description">
                    Halaman ini dirancang untuk membantu Anda mengelola pengiriman pesanan pelanggan. 
                    Pastikan setiap produk sampai dengan aman dan tepat waktu. Gunakan menu navigasi
                    untuk melihat pesanan pesanan yang harus dikirim hari ini.
                </p>
            </div>
        </div>
    </div>
